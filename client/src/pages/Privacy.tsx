...
export default function Privacy() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 text-ink-2 space-y-6 text-sm leading-relaxed">
      <h1 className="font-display-condensed text-3xl text-ink">Privacy</h1>
      <p>
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-ink">Data we hold</h2>
